import { View, Text, Dimensions, Image, TouchableHighlight, Alert, Platform } from 'react-native';
...
const Bill = () => {
    ...
    return (
        <View className='flex items-center justify-center '>
            {width > 0 && <View ref={billRef} style={{ width: width , height: width*1.3 }} className={`flex flex-col p-3 h-fit bg-green-bill rounded-md`}>
                <View className='flex flex-row gap-y-4 items-center justify-between'>
                    <View className='flex flex-row items-center gap-x-1'>
                        ...
                        <View className='flex flex-col justify-center gap-2'>
                            <Text className='text-base font-notobold text-black'>Transfer Completed</Text>
                            <Text className='text-sm text-black font-noto'>{new Date().toLocaleString()}</Text>
                        </View>
                    </View>
                    <View>
                ...
                <View className='px-2'>
                    <View className='flex flex-row gap-x-4 items-center'>
                        ...
                        <View className='flex flex-col gap-y-1'>
                            <Text className='text-sm font-notobold text-black'>MR. ASARAWOOT S</Text>
                            <Text className="text-xs font-noto text-black">FourQU</Text>
                            <Text className="text-xs font-noto text-black">xxx-x-x1924-x</Text>
                        </View>
                    </View>
                    ...
                    <View className='flex flex-row gap-x-4 items-center'>
                        ...
                        <View className='flex flex-col gap-y-1'>
                            <Text className='text-sm font-notobold text-black'>MR. MANUTSAWIN K</Text>
                            <Text className="text-xs font-noto text-black">FourQU</Text>
                            <Text className="text-xs font-noto text-black">xxx-xxx-1234</Text>
                        </View>
                    </View>

                    <View className='flex flex-col gap-y-2 mt-2'>
                        <Text className="font-notobold text-xs text-black">Transaction ID:</Text>
                        <View className='flex flex-row justify-end border-b-[1px] w-64'>
                            <Text className='font-noto text-xs text-black'>c1a71808-62ca-4c1b-8756-5942c11a84d0</Text>
                        </View>

                        <Text className = "font-notobold text-xs text-black">Amount:</Text>
                        <View className='flex flex-row justify-end border-b-[1px] w-64'>
                            <Text className='font-noto text-xs text-black'>144.00 Baht</Text>
                        </View>
                        ...
                        <View className='flex flex-row items-center gap-x-2 w-64'>
                            ...
                            <Text className='text-xs font-noto text-black'>Lorem ipsum dolor sit amet,.</Text>
                        </View>
                    </View>
